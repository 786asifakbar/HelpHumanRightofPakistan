   ...
   <>
    <PassPro backImgsrc = "/Web-Icon.png "
      ...
      p = "Food Aid At Help Human rights, we believe that access to nutritious food is a fundamental human right. Our Food Aid program is dedicated to combating hunger and food insecurity within
       ...
       to offer a variety of fresh and nutritious foods. Our goal is not only to alleviate immediate 
       hunger but also to promote healthy eating habits and improve overall well-being. 
       We prioritize reaching the most vulnerable populations, including children, the elderly, 
    ...
    />
      ...
      heading = "Your Donations Help Us Create This Impact"
       ...
       With your support, we can source more nutritious food, ensuring that the meals we provide 
       are balanced and nourishing. This is particularly important for children and the elderly,
       who require specific nutrients for healthy growth and aging. Your donations also enable us
       to increase the frequency and scale of our food distributions. This means we can serve more
       people, more often, and in more locations. Whether it's through emergency food packages
       during crises or regular meal services, your generosity ensures that we can meet the
       growing demand for food assistance in our community."
     />
   </>
  )
}
